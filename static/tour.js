(function () {
  ...
  var STEPS = [
    ...
    { icon: '\ud83d\udcd5', title: 'A home for your textbooks',
      body: 'Your books now live on their own \u201cTextbooks\u201d page (in the More menu). Upload a PDF and read it page by page \u2014 it remembers where you left off and lets you bookmark pages. Tap \u2630 Contents (or a book\u2019s \u201cChapters\u201d button) to jump straight to any chapter, fix the chapter page ranges by hand, or re-detect them with AI. When a unit begins or ends partway down a shared page, tap \u201cSplit page\u201d in the chapter editor to mark exactly where the break falls, so its lessons skip the neighbouring unit\u2019s text \u2014 the reader then draws that split as a dashed line right on the page (and in the extracted text) so you can check it landed in the right spot. From any chapter, tap \ud83d\udcc7 Build vocab deck or \ud83d\udcd8 Turn into lessons. Textbook units now sit in their own \u201cFrom your textbooks\u201d section on the Learn page, separate from your AI course, and you generate their lessons one tap at a time.', v: 25 },
  ];
