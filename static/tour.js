(function () {
  ...
  var STEPS = [
    ...
    { icon: '\u2691', title: 'Spotted a bad question? Rewrite it',
      body: 'If a drill is wrong \u2014 two options are both right, the answer isn\u2019t, an explanation contradicts itself \u2014 tap \u201cSomething wrong with this question?\u201d underneath it. Tell us what\u2019s off (or don\u2019t) and that one question gets rewritten and saved, so it\u2019s fixed for good rather than waiting for you every time you replay the lesson. The rest of the lesson stays exactly as it is. And when you write a sentence a different way and it\u2019s accepted, you now see the lesson\u2019s own answer next to yours, with a note on what actually differs between them.', v: 32 },
  ];
