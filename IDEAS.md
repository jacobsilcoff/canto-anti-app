...
- **Even Realities G2 glasses plugin** — Even Hub plugin (`even-glasses/`) lets you review due flashcards on G2 glasses hands-free. Tap to reveal, tap again for "got it" or double-tap for "missed it." XP, streak, and quests stay in sync. Non-Latin languages show romanization; Latin pronunciation faces (audio-only) are skipped. Server-side: `api_tokens` table (migration 037) for long-lived bearer tokens, generated/revoked in Settings → Even glasses. Replaces the earlier MentraOS approach (no OS change required). Tap to reveal, tap again for "got it" or double-tap for "missed it." XP, streak, and quests stay in sync. Non-Latin languages show romanization; Latin pronunciation faces (audio-only) are skipped. Server-side: `api_tokens` table (migration 037) for long-lived bearer tokens, generated/revoked in Settings → Even glasses. Replaces the earlier MentraOS approach (no OS change required).
