...
def _build_lesson_prompt(
    ...
    return (
        ...
        f"── TEACH BLOCKS ──\nAuthor 2–5 ordered blocks (like a textbook page). "
        f"Use PROSE to state the point plainly, TABLE for paradigms (conjugations, "
        f"articles, genders — headers in English), EXAMPLES for vocab, CONTRAST for "
        f"minimal pairs, NOTE for tips/common mistakes. Block types:\n{_BLOCK_TYPES}\n\n"
