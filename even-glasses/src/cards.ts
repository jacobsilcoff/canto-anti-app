/**
 * Pure helpers for turning a face card into what shows on the monochrome HUD.
 ...
 * face, in the reveal on the source/target faces), since without audio it is the
 * learner's only pronunciation cue.
 */
import type { DueCard, Face } from "./canto.js";
